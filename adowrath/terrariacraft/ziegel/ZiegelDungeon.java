...
public class ZiegelDungeon extends Block {

	public ZiegelDungeon(int i, Material mat)
	{
		super(i, mat);
    ...
    public void harvestBlock(World world, EntityPlayer player, int x, int y, int z, int MetaData)
    {
    	if(player.getCurrentEquippedItem() != null)
    	{
    		...
    		if(temp instanceof ItemSpitzhacke || temp instanceof ItemBohrer)
    		{
    			...
    			if(((MetaData == 4 || MetaData == 5) && itemDamage > 2 && temp instanceof ItemSpitzhacke) || temp instanceof ItemBohrer)
    			{
    				super.harvestBlock(world, player, x, y, z, MetaData);
    				return;
    			}
    			
    			if((MetaData == 6 && itemDamage > 4 && temp instanceof ItemSpitzhacke) || temp instanceof ItemBohrer)
    			{
    				super.harvestBlock(world, player, x, y, z, MetaData);
    				return;
    			}
    			
    			if((MetaData == 7 && itemDamage  == 6 && temp instanceof ItemSpitzhacke) || temp instanceof ItemBohrer)
    			{
    				super.harvestBlock(world, player, x, y, z, MetaData);
    				return;
    			}
    			
    			if(MetaData == 8 && temp instanceof ItemBohrer)
    			{
    				super.harvestBlock(world, player, x, y, z, MetaData);
    				return;
    			}
    			
    			if(MetaData == 9 && temp instanceof ItemBohrer && itemDamage != 0)
    			{
    				super.harvestBlock(world, player, x, y, z, MetaData);
    				return;
    			}
