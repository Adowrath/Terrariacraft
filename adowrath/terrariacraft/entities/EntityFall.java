package adowrath.terrariacraft.entities;

import adowrath.terrariacraft.blocks.BlockFall;
...
public class EntityFall extends Entity
{
    public int blockID;
    ...
    public EntityFall(World par1World)
    {
        super(par1World);
        this.fallTime = 0;
    ...
    public EntityFall(World par1World, double par2, double par4, double par6, int par8)
    {
        this(par1World, par2, par4, par6, par8, 0);
    }

    public EntityFall(World par1World, double par2, double par4, double par6, int par8, int par9)
    {
        super(par1World);
        this.fallTime = 0;
        this.field_70284_d = true;
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.onGround)
                {
                    ...
                    if (this.worldObj.getBlockId(var1, var2, var3) != Block.pistonMoving.blockID)
                    {
                        ...
                        if (!this.field_82157_e && this.worldObj.canPlaceEntityOnSide(this.blockID, var1, var2, var3, true, 1, (Entity)null) && !BlockFall.canFallBelow(this.worldObj, var1, var2 - 1, var3) && this.worldObj.setBlockAndMetadataWithNotify(var1, var2, var3, this.blockID, this.field_70285_b))
                        {
                            if (Block.blocksList[this.blockID] instanceof BlockFall)
                            {
                                ((BlockFall)Block.blocksList[this.blockID]).onFinishFalling(this.worldObj, var1, var2, var3, this.field_70285_b);
                            }
                        }
